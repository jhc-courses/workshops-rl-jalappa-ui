      ...
      <footer className="text-center text-lg-start bg-body-tertiary text-muted">
        <section className="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
          ...
          <div>
            ...
            <a href="https://javahome.in/" className="me-4 text-reset">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="30"
                height="25"
            ...
            <a
              href="https://www.linkedin.com/company/javahomecloud/?originalSubdomain=in"
              className="me-4 text-reset"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              href="https://www.youtube.com/@JavaHomeCloud "
              className="me-4 text-reset"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="row mt-3">
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                <h6 className="text-uppercase fw-bold mb-4">
                  <i className="fas fa-gem me-3"></i>Java Home Cloud
                </h6>
                <p>
                  Get Placed in 2 to 3 Months with Top Salaries. We Provide
                  Real-time traning. Certification & Placement.
                </p>
              </div>
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <p>
                  ...
                  2nd floor, # 85, SGR Dental College Rd, Kasavanahalli Village,
        ...
        >
          2023 @ All rights reserved. Java Home Cloud
        </div>
      </footer>
    </div>
  );
